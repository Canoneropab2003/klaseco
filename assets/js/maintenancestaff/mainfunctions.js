...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ✅ MOBILE MENU ELEMENTS (ADDED - like your first code)
  ...
  // ✅ Use the actual section IDs + .page-section class (FROM YOUR SECOND CODE)
  ...
  menuButtons.forEach(button => {
    button.addEventListener('click', () => {
      ...
      // ✅ AUTO-CLOSE SIDEBAR ON MOBILE AFTER CLICK (ADDED - like first code)
